 ...
 *
 * 【タイピングアニメーションの仕組み】
 *  dataset.fullText に全文を保存し、setTimeout で 30ms ごとに1文字ずつ表示する
 *  次へボタンを押したとき、アニメ中ならスキップ（全文即表示）、
 *  終わっていれば次のセリフへ進む
 *
 * 【{teacher1} などのプレースホルダー】
 *  JSON ファイル内の {teacher1}〜{teacher5} や {player} を
 *  _resolveName() でユーザーが入力した実際の名前に置き換えて表示する
 */
